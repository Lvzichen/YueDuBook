...
import com.example.administrator.yuedubook.adapter.FileAdapter;
import com.example.administrator.yuedubook.database.BookList;
import com.example.administrator.yuedubook.util.Fileutil;
...
public class FileActivity extends AppCompatActivity {
    ...
    private void handledButtonListener () {
        ...
        chooseAllButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                checkNum1 = FileAdapter.CheckNum(FileActivity.getIsSelected());
        ...
        putAsyncTask(new AsyncTask<Void, Void, Boolean>() {
            ...
            protected void onPostExecute(Boolean result) {
                ...
                if (result) {
                    ...
                    Toast.makeText(FileActivity.this, "查询失败", Toast.LENGTH_LONG)
                            .show();
                }
            }
        });
    ...
    public static void setIsSelected(HashMap<Integer,Boolean> isSelected) {
        FileActivity.isSelected = isSelected;
    }
